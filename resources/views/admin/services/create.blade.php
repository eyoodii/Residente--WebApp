...
<body class="bg-gray-100 antialiased font-sans">
    ...
    <div class="min-h-screen p-8">
        ...
        <div class="max-w-5xl mx-auto mb-8">
            ...
            <h1 class="text-3xl font-bold text-deep-forest">➕ Add New E-Service</h1>
            <p class="text-gray-600 mt-2">Define a new service that residents can request through the portal</p>
        </div>

        <!-- Form Content -->
        <form action="{{ route('admin.services.store') }}" method="POST" class="max-w-5xl mx-auto">
            @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" 
                                          rows="4"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                                          placeholder="Describe what this service provides...">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('processing_time_minutes') }}"
                                       min="0"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                        ...
                        <div id="requirementsContainer" class="space-y-3">
                            <div class="requirement-item flex gap-3 items-start">
                                <div class="flex-1 grid grid-cols-12 gap-3">
                                    <input type="text" 
                                           name="requirements[0][requirement]" 
                                    ...
                                    <input type="text" 
                                           name="requirements[0][where_to_secure]" 
                                    ...
                                    <label class="col-span-1 flex items-center justify-center" title="Mark as required">
                                        <input type="checkbox" name="requirements[0][is_required]" value="1" checked class="w-5 h-5 rounded text-sea-green">
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 sticky top-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                ...
                                <p class="text-xs text-gray-500 mt-2">Uncheck to create as unavailable</p>
                            </div>
                        </div>
                    </div>
