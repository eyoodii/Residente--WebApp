...
@section('title', 'Registered Farmers')
@section('content')
<div class="p-8 space-y-6">
    @include('department.components._module-header', ['icon'=>'🚜','title'=>'Registered Farmers','subtitle'=>'Residents classified under agricultural/farming livelihood.'])
